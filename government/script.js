...
if (location.search != '') {
    ...
    req.onload = function () {
        ...
        document.querySelector('div.agency-data').innerHTML += '<div class="jumbotron"><div class="container"><div class="row"><div class="col-sm-12"><h1>' + agency.name + short_name_text + '</h1></div></div></div></div><div class="container home-include"><div class="preview general"><div class="row"><div class="col-sm-3">' + img + '<ul class="list-unstyled pb-5">' + website + '<div class="parent-li"></div>' + '<li><a href="https://www.federalregister.gov/api/v1/agencies/' + agency.slug + '"><i class="fa-solid fa-database pr-2"></i> Data source</a></li>' + '</ul></div><div class="col-sm-9 post"><h2>About</h2><p>' + agency.description.replaceAll(/((http|https|ftp):\/\/[\w?=&.\/-;#~%-]+(?![\w\s?&.\/;#~%"=-]*>))/g, '<a href="$1" target="_blank">$1</a>') + '</p></div></div></div></div><div class="agency-children"></div></div><div class="container posts home-include"></div>';
